...
const MyServices = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "The backend of a web application is the part that works behind the scenes to make the application functional. It handles data storage, server logic, and communication with the frontend. Backend developers use technologies like Node.js, Express to build the server, and databases like MongoDB to store and manage data.",
    ...
    },
    {
      ...
      description:
        "Seamlessly integrating third-party APIs, secure payment gateways, and robust authentication systems to enhance functionality, scalability, and user experience.",
    ...
    },
    {
      ...
      description:
        "Creating immersive digital experiences through animations, micro-interactions, and motion design using Framer Motion, GSAP, AOS, and advanced CSS techniques.",
      ...
      >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              Delivering tailored digital solutions to empower your business
